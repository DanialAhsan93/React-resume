...
export default function Thirdtempmini() {
  ...
  return (
    <div onMouseEnter={handleshow} onMouseLeave={handledonotshow} >
      {
        show &&
        <div
          className='mous-eff'
      ...
      <div className='row px-0' style={{ background: "white" }}>
        ...
        <div className='col-3 pt-3 d-lg-block d-flex align-items-center'>
          {selectimages ? (
            <div className='updated-img-temp-3 border border-1'>
              <img
      ...
      <div className="row row-edit-sect justify-content-between " style={{ background: "white" }}>
        ...
        <div className="col-lg-5 px-0" style={{
          background: "#EBEBEB"
        }}>
