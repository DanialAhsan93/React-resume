...
import { ADR, CNTRY, CTY, EML, FIELD_EDIT, LNKD, NAME, PHN, ROLE, WEB } from '../../../../redux/actions/Actions';
...
export default function Sectemplarge() {
  ...
  return (
    ...
    <section className='py-5 my-5'>
      <div className='actual-resume'>
        ...
        <div className="row row-edit-sect justify-content-between " style={{
          width: '210mm',
          minHeight: '210mm',
          marginLeft: 'auto',
          marginRight: 'auto',
